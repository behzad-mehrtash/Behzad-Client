 ...
 * Original file: /home/behzad/git/mahda_client/MahdaClient/src/ir/rayacell/mahdaclient/bluetooth/IBluetoothHeadset.aidl
 */
package ir.rayacell.mahdaclient.bluetooth;
/**
...
public static abstract class Stub extends android.os.Binder implements ir.rayacell.mahdaclient.bluetooth.IBluetoothHeadset
{
private static final java.lang.String DESCRIPTOR = "ir.rayacell.mahdaclient.bluetooth.IBluetoothHeadset";
...
/**
 * Cast an IBinder object into an ir.rayacell.mahdaclient.bluetooth.IBluetoothHeadset interface,
 * generating a proxy if needed.
 */
public static ir.rayacell.mahdaclient.bluetooth.IBluetoothHeadset asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof ir.rayacell.mahdaclient.bluetooth.IBluetoothHeadset))) {
return ((ir.rayacell.mahdaclient.bluetooth.IBluetoothHeadset)iin);
}
return new ir.rayacell.mahdaclient.bluetooth.IBluetoothHeadset.Stub.Proxy(obj);
}
...
private static class Proxy implements ir.rayacell.mahdaclient.bluetooth.IBluetoothHeadset
{
